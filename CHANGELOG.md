...
# v20.2.0.0
* Upgrade to [Cumulusv20.2.0](https://github.com/nasa/cumulus/release/tag/v20.2.0)
...
* **NOTE** ORNL observed that no "enable_upgrade" variable remains in the cumulus-rds-tf module. Thus, initial run of 'make rds' will fail to delete the v13 parameter group, but will deploy the v17 parameter group. The remaining instructions can be followed from there.
